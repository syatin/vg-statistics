...
if test $GAMEMODE = "private5v5"; then
    ...
    nohup python $BASE_DIR/get_match_history.py private5v5 $REGION >> $BASE_DIR/log/get_match_history_5v5_private_${REGION}.log & echo $! > $BASE_DIR/5v5_private_${REGION}.pid
fi
