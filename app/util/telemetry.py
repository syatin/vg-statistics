...
def _analyze_5v5(match):
    ...
    for evt in telemetry:
        ...
        if evt_type == 'UseItemAbility':
            ...
            守護者の契約
            {
                "time": "2018-09-08T14:16:29+0000",
                "type": "UseItemAbility",
                "payload": {
                    "Team": "Right", "Actor": "*Ardan*", "Ability": "Protector Contract",
                    "Position": [ 1.80, 0.06, 1.44 ], "TargetActor": "None",
                    "TargetPosition": [ 1.80, 0.06, 1.44 ]
                }
            }
            ドラゴンブラッドの契約
            {
                "time": "2018-09-08T14:18:22+0000",
                "type": "UseItemAbility",
                "payload": {
                    "Team": "Right", "Actor": "*Grumpjaw*", "Ability": "Dragonblood Contract",
                    "Position": [ -1.70, 0.06, -52.35 ], "TargetActor": "None",
                    "TargetPosition": [ -1.70, 0.06, -52.35 ]
                }
            }
            """
            """
        ...
        if evt_type == 'KillActor' and payload['Killed'] in lane_minions:
            team = payload['Team']
            actor = payload['Actor']
